...
PROJECT TITLE: Dungeons & Dragons 
PURPOSE OF PROJECT: Text based Java game
VERSION or DATE: v6.0 Open Beta | Released on 31 JULY 2020 
HOW TO START THIS PROJECT: Runs on Blue J or similar JVM compatible App
AUTHORS: Pratyush Kumar
USER INSTRUCTIONS: This is a pre-release beta build of the game. You might encounter unexpected errors and bugs during the execution of the source code. If you find any such errors/ bugs, feel free to raise an Issue or a Pull Request. 
...
This is a pre-release beta preview of the game which focuses on the overall gameplay and quality of life changes.
This is sixth beta version of the game which introduces the new, interactive time module.
Is it 6 O'clock in your city? Well it's 6 O'clock in Kaza as well. The clock of Kaza runs on your local computer time.
The time module has given rise to various opportunities to explore in the game. Besides a vibrant nightlife,
the town will also feature some hidden gems, revealing in future updates.


*****CHANGELOG*****
1.Refined asset & scenario names 
